...
Object.assign(extra.es, {
  ...
  "admin.accessDenied": "No tenés permisos de administrador.",
  "admin.users": "Cuentas de usuarios",
  "admin.deleteUser": "Borrar cuenta",
  "admin.deleteUserConfirm": "¿Seguro que querés borrar esta cuenta? Esta acción no se puede deshacer.",
  "admin.userDeleted": "Cuenta eliminada",
  "admin.newLanguageName": "Nombre del nuevo idioma",
  "admin.newLanguageCode": "Código (ej.: ja)",
  "admin.newLanguageFlag": "Bandera: código de país (ej.: jp)",
  "admin.vocabularyPlaceholder": "Palabra | traducción\nhola | hello",
  "admin.vocabularyHelp": "Ingresá una palabra por línea, separando palabra y traducción con |.",
  "admin.manageCourse": "Gestionar curso",
  "admin.deleteCourse": "Borrar curso",
  "admin.deleteCourseConfirm": "¿Seguro que querés borrar este curso y sus lecciones?",
  "admin.courseDeleted": "Curso eliminado",
  "admin.deleteLesson": "Borrar lección",
  "admin.deleteLessonConfirm": "¿Seguro que querés borrar esta lección?",
  "admin.lessonDeleted": "Lección eliminada",
  "admin.manageLanguage": "Elegí el idioma a gestionar",
  "admin.lessonsInCourse": "Lecciones del curso",
  "admin.deleteLanguage": "Borrar idioma completo",
  "admin.deleteLanguageConfirm": "¿Seguro que querés borrar este idioma, todos sus cursos y sus lecciones? Esta acción no se puede deshacer.",
  "admin.languageDeleted": "Idioma eliminado",
...
Object.assign(extra.en, {
  ...
  "admin.accessDenied": "You don't have administrator permissions.",
  "admin.users": "User accounts",
  "admin.deleteUser": "Delete account",
  "admin.deleteUserConfirm": "Are you sure you want to delete this account? This cannot be undone.",
  "admin.userDeleted": "Account deleted",
  "admin.newLanguageName": "New language name",
  "admin.newLanguageCode": "Code (e.g.: ja)",
  "admin.newLanguageFlag": "Flag country code (e.g.: jp)",
  "admin.vocabularyPlaceholder": "Word | translation\nhola | hello",
  "admin.vocabularyHelp": "Enter one word per line, separating word and translation with |.",
  "admin.manageCourse": "Manage course",
  "admin.deleteCourse": "Delete course",
  "admin.deleteCourseConfirm": "Are you sure you want to delete this course and its lessons?",
  "admin.courseDeleted": "Course deleted",
  "admin.deleteLesson": "Delete lesson",
  "admin.deleteLessonConfirm": "Are you sure you want to delete this lesson?",
  "admin.lessonDeleted": "Lesson deleted",
  "admin.manageLanguage": "Choose the language to manage",
  "admin.lessonsInCourse": "Course lessons",
  "admin.deleteLanguage": "Delete entire language",
  "admin.deleteLanguageConfirm": "Are you sure you want to delete this language, all of its courses and lessons? This cannot be undone.",
  "admin.languageDeleted": "Language deleted",
});
Object.assign(extra.pt, {
  ...
  "admin.accessDenied": "Você não tem permissões de administrador.",
  "admin.users": "Contas de usuários",
  "admin.deleteUser": "Excluir conta",
  "admin.deleteUserConfirm": "Tem certeza de que deseja excluir esta conta? Esta ação não pode ser desfeita.",
  "admin.userDeleted": "Conta excluída",
  "admin.newLanguageName": "Nome do novo idioma",
  "admin.newLanguageCode": "Código (ex.: ja)",
  "admin.newLanguageFlag": "Código do país da bandeira (ex.: jp)",
  "admin.vocabularyPlaceholder": "Palavra | tradução\nhola | hello",
  "admin.vocabularyHelp": "Digite uma palavra por linha, separando palavra e tradução com |.",
  "admin.manageCourse": "Gerenciar curso",
  "admin.deleteCourse": "Excluir curso",
  "admin.deleteCourseConfirm": "Tem certeza de que deseja excluir este curso e suas lições?",
  "admin.courseDeleted": "Curso excluído",
  "admin.deleteLesson": "Excluir lição",
  "admin.deleteLessonConfirm": "Tem certeza de que deseja excluir esta lição?",
  "admin.lessonDeleted": "Lição excluída",
  "admin.manageLanguage": "Escolha o idioma para gerenciar",
  "admin.lessonsInCourse": "Lições do curso",
  "admin.deleteLanguage": "Excluir idioma completo",
  "admin.deleteLanguageConfirm": "Tem certeza de que deseja excluir este idioma, todos os seus cursos e lições? Esta ação não pode ser desfeita.",
  "admin.languageDeleted": "Idioma excluído",
});
